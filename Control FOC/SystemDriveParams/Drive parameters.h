...
/*** Encoder **********************/                                                                                                           
#define ENC_MEAS_ERRORS_BEFORE_FAULTS   20 /*!< Number of failed   
                                                        derived class specific speed 
                                                        measurements before main sensor  
                                                        goes in fault */
#define ENC_ICx_FILTER                  118 /*!< Duration of input  
...
#define ENC_AVERAGING_FIFO_DEPTH        16 /*!< depth of the FIFO used to 
                                                              ...
                                                              0.1Hz resolution */
/****** Hall sensors ************/ 
#define HALL_MEAS_ERRORS_BEFORE_FAULTS  20 /*!< Number of failed   
                                                           derived class specific speed 
                                                           measurements before main sensor  
                                                           goes in fault */
#define HALL_ICx_FILTER                 218 /*!< Duration of input  
                                                           capture filter in CPU clock   
...
#define PLL_KP_GAIN                      1097
#define PLL_KI_GAIN                      48

#define OBS_MEAS_ERRORS_BEFORE_FAULTS    20  /*!< Number of consecutive errors   
...
/* State observer constants */
#define CORD_GAIN1                       -21379
#define CORD_GAIN2                       19573

#define CORD_MEAS_ERRORS_BEFORE_FAULTS   20  /*!< Number of consecutive errors   
                                                           on variance test before a speed 
                                                           feedback error is reported */
...
#define CORD_FIFO_DEPTH_01HZ             64  /*!< Depth of the FIFO used  
                                                           to average mechanical speed  
                                                           in dpp format */        
#define CORD_MAX_ACCEL_DPPP              90  /*!< Maximum instantaneous 
...
#define PID_TORQUE_KP_DEFAULT         2001       
#define PID_TORQUE_KI_DEFAULT         2083
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2001
#define PID_FLUX_KI_DEFAULT           2083
...
#define SPEED_LOOP_FREQUENCY_HZ       500 /*!<Execution rate of speed   
                                                      regulation loop (Hz) */
#define PID_SPEED_KP_DEFAULT          700
#define PID_SPEED_KI_DEFAULT          1
...
#define FINAL_I_ALIGNMENT               1651 /*!< s16A */
...
#define CONSTANT1_Q                    390185
#define CONSTANT1_D                    390185
#define CONSTANT2_QD                   28376
