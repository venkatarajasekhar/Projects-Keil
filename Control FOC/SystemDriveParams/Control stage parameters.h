...
/* Hall timer section */
#define HALL_TIMER_SELECTION              HALL_TIM5  /* HALL_TIM2...HALL_TIM5 */ 
#define HALL_TIMER_REMAPPING              NO_REMAP_TIM5  /* NO_REMAP, FULL_REMAP, 
                                                            PARTIAL_REMAP */
#define H1_GPIO_PORT                      GPIOH
#define H2_GPIO_PORT                      GPIOH
#define H3_GPIO_PORT                      GPIOH
...
#define ENC_TIMER_SELECTION               ENC_TIM5  /* ENC_TIM2...HALL_TIM5 */ 
#define ENC_TIMER_REMAPPING               NO_REMAP_TIM5  /* NO_REMAP, FULL_REMAP, 
                                                            PARTIAL_REMAP */
#define ENC_A_GPIO_PORT                   GPIOH
#define ENC_B_GPIO_PORT                   GPIOH
#define ENC_A_GPIO_PIN                    GPIO_Pin_10
#define ENC_B_GPIO_PIN                    GPIO_Pin_11
...
#define PHASE_V_CURR_CHANNEL            ADC_Channel_4
#define PHASE_V_GPIO_PORT               GPIOA
#define PHASE_V_GPIO_PIN                GPIO_Pin_4
/* Only for three shunts case */
#define PHASE_W_CURR_ADC                ADC1_2
#define PHASE_W_CURR_CHANNEL            ADC_Channel_5
...
#define VBUS_ADC_SAMPLING_TIME          3

#define TEMP_FDBK_ADC                   ADC1_2
#define TEMP_FDBK_CHANNEL               ADC_Channel_7
#define TEMP_FDBK_GPIO_PORT             GPIOA
#define TEMP_FDBK_GPIO_PIN              GPIO_Pin_7
#define TEMP_ADC_SAMPLING_TIME          56
